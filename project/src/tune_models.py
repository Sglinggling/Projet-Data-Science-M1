...
TUNE_SUBSAMPLE  = 30_000   # rows from X_train used for the randomised search
N_ITER          = 15
CV_FOLDS        = 3
SCORING         = "f1_macro"
DEFAULT_RF_F1   = 0.9587   # baseline from train_models.py
...
def tune_model(
    ...
    best_params_raw = search.best_params_          # e.g. {"clf__n_estimators": 200, …}
    best_cv_score   = round(search.best_score_, 4)

    # Strip "clf__" prefix to pass directly to the constructor
